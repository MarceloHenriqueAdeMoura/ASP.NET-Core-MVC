...
using SalesWebApplication.Models.Enums;
using System;
...
namespace SalesWebApplication.Data
{
    ...
    {
        private SalesWebApplicationContext _context;

        public SeedingService(SalesWebApplicationContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller { Name = "Bob", Email = "bob@gmail.com", BirthDate = new DateTime(1998, 4, 21), BaseSalary = 1000.0, Department = d1 };
            Seller s2 = new Seller { Name = "Maria", Email = "maria@gmail.com", BirthDate = new DateTime(1979, 12, 31), BaseSalary = 3500.0, Department = d2 };
            Seller s3 = new Seller { Name = "Martha", Email = "martha@gmail.com", BirthDate = new DateTime(1988, 1, 15), BaseSalary = 2200.0, Department = d3 };
            Seller s4 = new Seller { Name = "Alex", Email = "alex@gmail.com", BirthDate = new DateTime(1993, 11, 30), BaseSalary = 3000.0, Department = d4 };
